...
export default [
  {
    ...
    component: ComponentCreator('/InstaForce/blog', '250'),
    exact: true
  },
  {
  ...
  {
    path: '/InstaForce/blog/tags/blockchain',
    component: ComponentCreator('/InstaForce/blog/tags/blockchain', '72f'),
    exact: true
  },
  {
    path: '/InstaForce/blog/tags/community',
    component: ComponentCreator('/InstaForce/blog/tags/community', '107'),
    exact: true
  },
  {
    path: '/InstaForce/blog/tags/design',
    component: ComponentCreator('/InstaForce/blog/tags/design', 'c07'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/InstaForce/blog/tags/documentation', '53b'),
    exact: true
  },
  {
    path: '/InstaForce/blog/tags/game-based-research',
    component: ComponentCreator('/InstaForce/blog/tags/game-based-research', '0f5'),
    exact: true
  },
  {
  ...
  {
    path: '/InstaForce/blog/tags/tokenization',
    component: ComponentCreator('/InstaForce/blog/tags/tokenization', 'c45'),
    exact: true
  },
  {
  ...
  {
    path: '/InstaForce/blog/tags/updates',
    component: ComponentCreator('/InstaForce/blog/tags/updates', '83c'),
    exact: true
  },
  {
    path: '/InstaForce/blog/tags/website',
    component: ComponentCreator('/InstaForce/blog/tags/website', '203'),
    exact: true
  },
  {
    path: '/InstaForce/blog/tokenization-and-game-research',
    component: ComponentCreator('/InstaForce/blog/tokenization-and-game-research', 'b19'),
    exact: true
  },
  {
    path: '/InstaForce/blog/website-design-enhancement',
    component: ComponentCreator('/InstaForce/blog/website-design-enhancement', '28a'),
    exact: true
  },
  {
  ...
  },
  {
    ...
    component: ComponentCreator('/InstaForce/docs', '406'),
    routes: [
      {
        path: '/InstaForce/docs',
        component: ComponentCreator('/InstaForce/docs', '9c7'),
        routes: [
          {
            path: '/InstaForce/docs',
            component: ComponentCreator('/InstaForce/docs', '2e3'),
            routes: [
              {
              ...
              {
                path: '/InstaForce/docs/research-documentation/game-based-research-platform',
                component: ComponentCreator('/InstaForce/docs/research-documentation/game-based-research-platform', 'ed1'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/InstaForce/docs/research-documentation/quantum-battery-prototype',
                component: ComponentCreator('/InstaForce/docs/research-documentation/quantum-battery-prototype', '705'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/InstaForce/docs/tokenization-strategy',
                component: ComponentCreator('/InstaForce/docs/tokenization-strategy', '83e'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
